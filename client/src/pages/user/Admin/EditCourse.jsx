        ...
        const fetchCourse = async () => {
            try {
                ...
                form.reset({
                    ...
                    lectures: response.course.lectures.map(lecture => ({
                        id: lecture._id,
                        title: lecture.title,
                        video: null
                    }))
                                                        ...
                                                        >
                                                            {value ? (
                                                                <div className="relative">
                                                                    <img
                                                                        src={value instanceof File ? URL.createObjectURL(value) : course.thumbnail.url}
                                                                    ...
                                                                    <div className="flex items-center gap-4">
                                                                        ...
                                                                        {value && (
                                                                            <span className="text-sm text-gray-500">
                                                                                {value instanceof File ? value.name : 'Current video'}
                                                                            </span>
                                                                        )}
                                                                    </div>
                                                                </FormControl>
