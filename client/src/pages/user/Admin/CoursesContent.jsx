...
const CourseRow = ({ course, onEdit, onShare, onDelete }) => (
  <TableRow>
    <TableCell className="font-medium">
      <div className="flex items-center">
        ...
        <span className="cursor-pointer hover:underline" onClick={() => onEdit(course._id)}>
          {course.title}
        </span>
      </div>
    </TableCell>
    ...
    <TableCell>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => onDelete(course._id)} className="text-red-600">
            ...
            <TableHeader>
              <TableRow>
                <TableHead className="w-[400px]">
                  <SortButton label="Course" sortKey="title" sortConfig={sortConfig} onSort={handleSort} />
                </TableHead>
                <TableHead>Lectures</TableHead>
                <TableHead className="text-right">
                  <SortButton label="Price" sortKey="price" sortConfig={sortConfig} onSort={handleSort} />
                </TableHead>
